...
function sandbox_globalnav() {
	if ( $user_ID ) :
		$pagelist = wp_list_pages('title_li=&sort_column=menu_order&echo=0&include=');
	else :		
//		$pagelist = wp_list_pages('title_li=&sort_column=menu_order&echo=0&include=19'); //DEV
		$pagelist = wp_list_pages('title_li=&sort_column=menu_order&echo=0&include=3'); //LIVE
	endif;		
//	if ( $menu = str_replace( array( "\r", "\n", "\t" ), '', wp_list_pages('title_li=&sort_column=menu_order&echo=0&include=') ) )
if ( $menu = str_replace( array( "\r", "\n", "\t" ), '', $pagelist ) )
	$menu = '<ul>' . $menu . '</ul>';
...
function sandbox_gglobalnav() {
//	if ( $user_ID ) :
//	wp_list_pages('title_li=<h2>Pages</h2>&include=');
//	else :		
//		wp_list_pages('title_li=<h2>Pages</h2>&include=19');
//	endif;		
}
...
//add Secondary email
$contactmethods['email2'] = 'Secondary e-mail address';
//add Phone mobile
$contactmethods['phonemobile'] = 'Mobile phone';
//add Phone home
$contactmethods['phonehome'] = 'Home phone';
//add Phone work
$contactmethods['phonework'] = 'Work phone';
//add Street address
$contactmethods['street'] = 'Street address';
//add City
$contactmethods['city'] = 'City';
//add GEO tag
$contactmethods['geo'] = 'GEO info';
// Remove Yahoo IM
